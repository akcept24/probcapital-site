  ...
  const plans = [
    {
      ...
      rules: [
        ...
        { label: tr.ch_leverage,value: "1:20 (up to 1:100)", good: true },
  ...
  return (
    <section id="challenges" className="py-12 px-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mt-6 max-w-[900px] mx-auto px-4 py-3 rounded-xl text-[11px] text-[#454A5E] text-center leading-relaxed"
          style={{ background: "rgba(255,255,255,0.015)", border: "1px solid rgba(255,255,255,0.04)" }}>
          {lang === "ru"
            ? "Все счета являются симулированными торговыми средами; реальный капитал не используется. Оценочный взнос оплачивается единовременно — подписки отсутствуют. Рибейт взноса выплачивается вместе с первой одобренной выплатой по результатам оценки при соблюдении всех условий программы. Выплаты производятся ProbCapital LLC из собственных операционных средств и требуют прохождения KYC-верификации. Прошлые результаты не гарантируют будущих. Цены указаны в USD и могут не включать применимые налоги."
            : "All accounts are simulated trading environments; no real capital is deployed. Evaluation fees are one-time payments — no subscription. The fee rebate is applied with the first approved performance payout upon meeting all program conditions. Payouts are made by ProbCapital LLC from its own operating funds and require completed KYC verification. Past performance does not guarantee future results. Prices are in USD and may exclude applicable taxes."}
        </div>
      </div>
    </section>
  );
