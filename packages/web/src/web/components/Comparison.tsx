...
const labels = {
  en: {
    ...
    rows: [
      ...
      { feature: "Bank wire payouts", us: true, them: false },
    ...
    note: "Based on publicly available information from selected prop trading evaluation firms as of 2026. Features and policies vary; verify directly with each firm.",
  ...
  ru: {
    ...
    rows: [
      ...
      { feature: "Банковские выплаты", us: true, them: false },
    ...
    note: "На основе публично доступной информации от отдельных компаний по оценке проп-трейдинга по состоянию на 2026 год. Условия и политики могут различаться; проверяйте непосредственно у каждой компании.",
    cta: "Начать оценку →",
  },
};
