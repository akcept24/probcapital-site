...
const labels = {
  en: {
    ...
    h2_1: "Real Traders.",
    h2_2: "Real Payouts.",
    sub: "Real people. Real payouts. See what our funded traders are achieving.",
    style: "Trading Style",
    views: "views",
    stat1: "90%", label1: "Max Performance Split",
    stat2: "$400K", label2: "Max Simulated Capital",
    stat3: "24h", label3: "Payout Processing",
    stat4: "15%", label4: "Max Affiliate Commission",
    withdrawal: "Withdrawal",
    verified: "VERIFIED",
  },
  ru: {
    badge: "Сообщество",
    h2_1: "Реальные трейдеры.",
    h2_2: "Реальные выплаты.",
    sub: "Реальные люди. Реальные выплаты. Посмотрите, чего достигают наши финансируемые трейдеры.",
    style: "Стиль торговли",
    views: "просмотров",
    stat1: "90%", label1: "Максимальный сплит прибыли",
    stat2: "$400K", label2: "Макс. симулированный капитал",
    stat3: "24ч", label3: "Обработка выплат",
    stat4: "15%", label4: "Макс. партнёрская комиссия",
