  ...
  return (
    <section className="py-12 px-6 overflow-hidden">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* Results disclaimer */}
        <p className="text-center text-[11px] text-[#454A5E] mt-5 max-w-[700px] mx-auto leading-relaxed">
          {ru
            ? "Отзывы от реальных участников программы. Индивидуальные результаты могут существенно отличаться. Приведённые суммы выплат не являются типичными и не гарантируют аналогичного дохода. Прошлые результаты не свидетельствуют о будущих. Все торговые среды являются симуляциями."
            : "Testimonials are from actual program participants. Individual results vary significantly. Payout amounts shown are not typical and do not guarantee similar earnings. Past performance is not indicative of future results. All trading environments are simulations."}
        </p>
      </div>
    </section>
  );
