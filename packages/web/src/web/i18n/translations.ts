...
export const t = {
  en: {
    ...
    // How It Works
    hiw_badge: "Scaling Program",
    hiw_h2_1: "Your Path to",
    hiw_h2_2: "Institutional Capital",
    hiw_sub: "Four structured stages from initial evaluation to managing institutional-level capital.",
    hiw_s1_title: "Skill Evaluation",
    hiw_s1_desc: "Trade in a simulated environment mirroring live market conditions. Prove your strategy under real risk discipline: −5% daily drawdown, −10% max drawdown, +10% profit target.",
    hiw_s2_title: "Performance Verification",
    hiw_s2_desc: "Confirm consistency in Phase 2 with a +5% profit target. Our analytics module verifies risk parameter compliance before granting funded access.",
    hiw_s3_title: "Capital Scaling",
    hiw_s3_desc: "Pass verification and receive your funded account. Capital increases 25% for every 10% profitable cycle — compounding growth with no ceiling until the next tier.",
    hiw_s4_title: "Elite Tier",
    hiw_s4_desc: "Top performers reach up to $2,000,000 in allocated capital. Priority infrastructure, tightened spreads, and a dedicated risk manager for tier-1 participants.",

    // Challenges
    ch_badge: "Pricing",
    ch_h2_1: "Choose Your",
    ch_h2_2: "Challenge",
    ch_sub: "One-time fee. No subscriptions. Evaluation fee rebate on first approved payout.",
    ch_standard: "Standard",
    ch_aggressive: "Aggressive",
    ch_popular: "⭐ MOST POPULAR",
    ch_onetime: "one-time",
    ch_refunded: "Evaluation fee rebate on first approved payout",
    ...
    ch_note: "✓ 1 free re-take if you fail  ·  ✓ Funded in under 24h  ·  ✓ Evaluation fee rebate on first approved payout",
    ch_days: "days",
    ch_weekly: "Weekly",
    ...
    cta_btn2: "Learn More",
    cta_t1: "Evaluation fee rebate on first approved payout",
  ...
  ru: {
    ...
    // How It Works
    hiw_badge: "Программа масштабирования",
    hiw_h2_1: "Ваш путь к",
    hiw_h2_2: "управлению капиталом",
    hiw_sub: "Четыре этапа от первичной оценки до управления капиталом на институциональном уровне.",
    hiw_s1_title: "Оценка навыков",
    hiw_s1_desc: "Торгуйте в симулированной среде, отражающей реальные рыночные условия. Докажите стратегию при дисциплине риска: дневная просадка −5%, максимальная −10%, цель +10%.",
    hiw_s2_title: "Верификация результатов",
    hiw_s2_desc: "Подтвердите последовательность в Фазе 2 с целью +5%. Аналитический модуль проверяет соответствие риск-параметров перед допуском к финансированию.",
    hiw_s3_title: "Масштабирование капитала",
    hiw_s3_desc: "Пройдите верификацию — получите финансируемый счёт. Капитал увеличивается на 25% за каждые 10% прибыльного цикла с неограниченным ростом до следующего уровня.",
    hiw_s4_title: "Элитный уровень",
    hiw_s4_desc: "Лучшие трейдеры достигают управления капиталом до $2 000 000. Приоритетная инфраструктура, пониженные спреды и выделенный риск-менеджер для топ-тирных участников.",

    // Challenges
    ch_badge: "Тарифы",
    ch_h2_1: "Выберите свой",
    ch_h2_2: "Челлендж",
    ch_sub: "Разовая оплата. Без подписок. Рибейт оценочного взноса при первой одобренной выплате.",
    ch_standard: "Стандартный",
    ch_aggressive: "Агрессивный",
    ch_popular: "⭐ ПОПУЛЯРНЫЙ",
    ch_onetime: "разово",
    ch_refunded: "Рибейт взноса при первой одобренной выплате",
    ...
    ch_note: "✓ 1 бесплатный рестарт  ·  ✓ Финансирование за 24ч  ·  ✓ Рибейт взноса при первой одобренной выплате",
    ch_days: "дней",
    ...
    cta_t1: "Рибейт взноса при первой одобренной выплате",
