        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
          ...
          <SectionBlock title={ru ? "2. Момент полного оказания услуги" : "2. Service Delivery & Full Rendering"}>
            {ru ? (
              <>
                ...
                <Ul items={[
                  "первое размещение симулированного ордера в программной среде оценки; или",
              ...
              <>
                ...
                <Ul items={[
                  "placement of the first simulated trade within the evaluation software simulation environment; or",
          ...
          <SectionBlock title={ru ? "8. Политика в отношении чарджбэков" : "8. Chargeback Policy"}>
            {ru ? (
              <>
                <p style={{ marginBottom: "14px" }}>
                  Если у вас возник вопрос по биллингу или платежу, мы настоятельно рекомендуем сначала обратиться в нашу службу поддержки по адресу <a href="mailto:support@probcapital.com" style={{ color: "#00D4AA", textDecoration: "none" }}>support@probcapital.com</a>. Мы стремимся разрешить все обоснованные вопросы в кратчайшие сроки — как правило, в течение 2 рабочих дней.
                </p>
                <p style={{ marginBottom: "14px" }}>
                  Если вы считаете, что платёж был осуществлён ошибочно или без вашего разрешения, вы вправе обратиться к своему банку или платёжному оператору. Мы уважаем ваши права как потребителя и не ограничиваем какие-либо законные права на оспаривание транзакций.
                </p>
                <WarnBox>
                  Инициирование чарджбэка без предварительного письменного обращения в ProbCapital является нарушением настоящих Условий. При необоснованном чарджбэке Компания оставляет за собой право приостановить действие аккаунта до завершения разбирательства и предоставить платёжному оператору документацию о факте оказания услуги.
                </WarnBox>
              </>
            ) : (
              <>
                <p style={{ marginBottom: "14px" }}>
                  If you have a billing question or believe a charge was made in error, we strongly encourage you to contact our support team at <a href="mailto:support@probcapital.com" style={{ color: "#00D4AA", textDecoration: "none" }}>support@probcapital.com</a> first. We aim to resolve all legitimate concerns promptly — typically within 2 business days.
                </p>
                <p style={{ marginBottom: "14px" }}>
                  If you believe a payment was made without your authorisation or in error, you retain the right to contact your bank or payment provider. We respect your statutory rights as a consumer and do not restrict any non-waivable right to dispute a transaction.
                </p>
                <WarnBox>
                  Initiating a chargeback without first contacting ProbCapital in writing constitutes a breach of these Terms. Where a chargeback is filed without prior contact, the Company reserves the right to suspend the account pending resolution and to provide the payment processor with documentation evidencing service delivery.
                </WarnBox>
              </>
            )}
          </SectionBlock>
