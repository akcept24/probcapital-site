            ...
            {ru ? (
              <>
                ...
                <p style={{ marginTop: "14px" }}>
                  <strong style={{ color: "#E0E8FF" }}>Отказ от арбитража:</strong> Вы вправе отказаться от обязательного арбитража, направив письменное уведомление на адрес <a href="mailto:legal@probcapital.com" style={{ color: "#00D4AA", textDecoration: "none" }}>legal@probcapital.com</a> в течение <strong style={{ color: "#E0E8FF" }}>30 дней</strong> с момента первого принятия настоящих Условий. Уведомление должно содержать ваше полное имя, зарегистрированный email и чёткое заявление об отказе от арбитража. В случае отказа споры разрешаются в судах штата Делавэр.
                </p>
                <p style={{ marginTop: "12px", color: "#8A8FA8", fontSize: "13px" }}>
                  Ничто в настоящем разделе не ограничивает неотчуждаемые права потребителя, которые могут предоставляться вам законодательством вашей юрисдикции.
                </p>
              </>
            ) : (
              <>
                ...
                <p style={{ marginTop: "14px" }}>
                  <strong style={{ color: "#E0E8FF" }}>Arbitration Opt-Out:</strong> You may opt out of binding arbitration by sending written notice to <a href="mailto:legal@probcapital.com" style={{ color: "#00D4AA", textDecoration: "none" }}>legal@probcapital.com</a> within <strong style={{ color: "#E0E8FF" }}>30 days</strong> of first accepting these Terms. Your opt-out notice must include your full name, registered email address, and a clear statement that you are opting out of arbitration. If you opt out, disputes will be resolved in the courts of the State of Delaware.
                </p>
                <p style={{ marginTop: "12px", color: "#8A8FA8", fontSize: "13px" }}>
                  Nothing in this section limits any non-waivable consumer rights you may have under the laws of your jurisdiction.
                </p>
              </>
            )}
          </S>
