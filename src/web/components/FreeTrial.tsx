...
import { appRegister, appPlans } from "../lib/app-links";
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-12 p-10 md:p-14 items-center">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href={appRegister()} className="gold-gradient text-[#0F1117] text-[15px] font-bold px-7 py-3.5 rounded-xl hover:opacity-90 transition-opacity text-center"
                  style={{ boxShadow: "0 8px 24px rgba(0,212,170,0.25)" }}>
                  {l.cta}
                </a>
                <a href={appPlans()} className="text-[#F0F2FF] text-[15px] font-semibold px-7 py-3.5 rounded-xl text-center transition-all duration-200"
