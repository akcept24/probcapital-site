...
import { appLogin, appPlans, appDashboard } from "../lib/app-links";
    ...
    >
      <div className="max-w-[1200px] mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            href={appDashboard()}
            className="text-[14px] text-[#8A8FA8] hover:text-[#F0F2FF] transition-colors font-medium px-3 py-2"
          >
            {tr.nav_dashboard}
          </a>
          <a
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-white/5 bg-[#0F1117]">
          <div className="max-w-[1200px] mx-auto px-6 py-4 flex flex-col gap-4">
            ...
            <a
              href={appLogin()}
              className="text-[15px] text-[#8A8FA8] hover:text-[#F0F2FF] transition-colors font-medium py-2 border-b border-white/5"
              onClick={() => setMenuOpen(false)}
            >
              {tr.nav_login}
            </a>
