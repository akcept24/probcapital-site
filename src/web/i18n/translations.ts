...
export const t = {
  en: {
    ...
    // Hero
    hero_badge: "Over $2.4M Paid to Traders",
    hero_h1_1: "Trade With Our Capital.",
    hero_h1_2: "Keep Your Profits.",
    hero_sub: "Pass our evaluation, get funded up to",
    hero_sub_amount: "$400,000",
    hero_sub_mid: "in trading capital, and earn up to",
    hero_sub_split: "90% profit splits",
    hero_cta1: "Start Challenge →",
    ...
    ch_note: "1 free re-take if you fail · Instant funding after passing",
    ch_days: "days",
    ch_weekly: "Weekly",
    ...
    test_quotes: [
      "Passed the $100K challenge in 18 days. The payout was in my account within a few hours. Probcapital is the real deal — no delays, no excuses.",
      "I've tried 4 other prop firms. Probcapital is by far the most transparent. Rules are clear, dashboard is clean, and support actually responds.",
      "Been with Probcapital for 8 months. Already scaled to $400K. The scaling program is legit — they actually want you to succeed.",
      "Aggressive plan with 90% split is insane. No minimum days makes it perfect for my strategy. Got funded in under 24h after passing.",
      "Probcapital's community Discord is worth it alone. Tons of funded traders sharing setups daily. The webinars are high quality.",
      "First payout received exactly as promised. The live dashboard helped me stay disciplined and avoid revenge trading. Highly recommend.",
    ],
  ...
  ru: {
    ...
    // Hero
    hero_badge: "Выплачено трейдерам более $2.4M",
    hero_h1_1: "Торгуйте нашим капиталом.",
    hero_h1_2: "Забирайте прибыль.",
    hero_sub: "Пройдите оценку и получите финансирование до",
    hero_sub_amount: "$400,000",
    hero_sub_mid: "торгового капитала с выплатой до",
    hero_sub_split: "90% от прибыли",
    hero_cta1: "Начать челлендж →",
    ...
    ch_note: "1 бесплатный рестарт при провале · Мгновенное финансирование после прохождения",
    ch_days: "дней",
    ...
    test_quotes: [
      "Прошёл челлендж $100K за 18 дней. Выплата поступила на счёт в течение нескольких часов. Probcapital — это реально работающая компания, без задержек и отговорок.",
      "Пробовал 4 другие проп-фирмы. Probcapital — самая прозрачная. Правила понятны, дашборд чистый, а поддержка действительно отвечает.",
      "Работаю с Probcapital 8 месяцев. Уже вырос до $400K. Программа масштабирования реальная — они действительно хотят, чтобы вы зарабатывали.",
      "Агрессивный план с 90% сплитом — это невероятно. Отсутствие минимума дней идеально для моей стратегии. Получил финансирование менее чем за 24 часа.",
      "Discord-сообщество Probcapital стоит отдельных денег. Сотни финансируемых трейдеров ежедневно делятся сетапами. Вебинары высокого уровня.",
      "Первая выплата пришла точно по обещанию. Живой дашборд помог сохранить дисциплину и не торговать на эмоциях. Рекомендую.",
    ],
